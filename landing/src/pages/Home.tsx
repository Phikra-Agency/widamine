  ...
  return (
    <section ref={heroRef} className='relative overflow-hidden' style={{ background: C.bg, minHeight: '100svh' }}>
      ...
      <div className='relative z-20 mx-auto mt-32 max-w-[980px] px-5 pb-0 sm:mt-36' data-video-wrap>
        ...
        >
          <img src='/hero.webp' alt='' className='absolute inset-0 h-full w-full object-cover widamine-tint' loading='eager' fetchPriority='high' decoding='async' />
          <div className='absolute inset-0 bg-[#009FD6]/10 mix-blend-color pointer-events-none' aria-hidden />
        </div>
      </div>
