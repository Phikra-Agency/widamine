  ...
  return (
    <section ref={heroRef} className='relative overflow-hidden' style={{ background: C.bg, minHeight: '100svh' }}>
      ...
      <div className='relative z-20 mx-auto mt-32 max-w-[980px] px-5 pb-0 sm:mt-36' data-video-wrap>
        ...
        >
          <img src='/hero.webp' alt='' className='absolute inset-0 h-full w-full object-cover' loading='eager' fetchPriority='high' decoding='async' style={{ filter: 'saturate(0.92) brightness(1.03)' }} />
          <div className='absolute inset-0 bg-[#009FD6]/[0.05] pointer-events-none' aria-hidden />
        </div>
      </div>
