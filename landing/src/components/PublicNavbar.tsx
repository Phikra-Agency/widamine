                            ...
                            <div className='space-y-1'>
                              {cat.items.map((item) => (
                                ...
                                >
                                  ...
                                  <span className='truncate font-medium opacity-85 transition-all duration-500 ease-out group-hover:font-bold group-hover:opacity-100 group-hover:[text-shadow:0_0_0.3px_currentColor]'>{item.label}</span>
                                </Link>
                              ))}
                            </div>
                          </motion.div>
