...
function DataTableMobileCard({
  ...
  return (
    <div
      ...
      className={cn(
        'rounded-control border border-border-subtle bg-transparent px-4 py-3',
...
function DataTableEmpty({
  ...
  const content = (
    <div className={cn('flex flex-col items-center gap-4 px-6 py-12 text-center', className)}>
      {Illustration ? (
        <Illustration className='h-auto w-full max-w-[220px]' />
      ) : IconComponent ? (
        <div className='flex h-12 w-12 items-center justify-center rounded-control bg-muted'>
  ...
  return (
    <div className='rounded-control border border-dashed border-border bg-background/80'>
      {content}
    </div>
  )
}
        ...
        <TableRow key={i} className='hover:bg-transparent'>
          <TableCell colSpan={colSpan} className='px-4 py-2.5'>
            <div className='flex items-center gap-3'>
              <div className='h-8 w-8 shrink-0 rounded-element bg-muted' />
