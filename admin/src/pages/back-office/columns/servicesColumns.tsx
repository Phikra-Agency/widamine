import { EmptyServicesIllustration } from '@/components/illustrations'
    ...
    },
    {
      ...
      cell: ({ row }) =>
        row.original.category?.name ? (
          <span className='inline-flex items-center rounded-element border border-violet-100 bg-violet-50 px-2.5 py-1 text-xs font-medium text-violet-700'>
            {row.original.category.name}
          </span>
        ) : (
          '—'
...
export const SERVICES_EMPTY_ILLUSTRATION = EmptyServicesIllustration
