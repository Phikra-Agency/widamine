      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-1'>
          {open && (
            <Link
              to='/back-office/patients'
              className='mr-1 flex items-center gap-0.5 rounded-lg bg-primary/8 px-2 py-1 text-[9px] font-semibold text-primary/70'
            >
          ...
          <div>
            {active.data ? (
              <button
                ...
                className='w-full rounded-lg border border-border-subtle bg-card/70 px-3 py-2 text-left transition hover:border-primary/20'
              >
              ...
              <div className='rounded-lg border border-dashed border-border bg-card/40 px-3 py-2.5 text-center'>
